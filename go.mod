...
require (
	...
	github.com/evrblk/monstera v0.0.0-20260825150647-4b5fb47b1fc3
	github.com/evrblk/yellowstone-common v0.0.0-20260825180005-d53bdcf78940
...
tool github.com/evrblk/yellowstone-common/codegen/genmarshal
